...
def main():
    ...
    # Setup logging
    args.output_dir = f'{path}/{args.output_dir}'
    ...
    for epoch in itertools.count():
        for batch_host in train_loader:
            ...
            if False:
                ...
                grs = GlobalRescaleShift(scale_by=True, shift_by=True)
                unscaled_targets = grs.unscale(unscaled_targets, force_process=True)
