...
model_type = "fastpot"
model_path = "test/fastpot/output/model.pt"
...
df.to_csv('test/fastpot/output/predictions.csv', index=False)
...
plt.title(f'HOTMEM: DFT vs NNP Energy (RMSE: {rmse:.4f})')
plt.savefig('test/fastpot/output/energy_comparison.png')
plt.show()
