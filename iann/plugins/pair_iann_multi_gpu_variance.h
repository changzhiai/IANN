...
#ifdef PAIR_CLASS
// clang-format off
PairStyle(iann/multi_gpu/variance,PairIANNMultiGPUVariance);
// clang-format on
#else

#ifndef LMP_PAIR_IANN_MULTI_GPU_VARIANCE_H
#define LMP_PAIR_IANN_MULTI_GPU_VARIANCE_H
...
class PairIANNMultiGPUVariance : public Pair {
 public:
  PairIANNMultiGPUVariance(class LAMMPS *);
  ~PairIANNMultiGPUVariance() override;
